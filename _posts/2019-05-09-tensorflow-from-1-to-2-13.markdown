...
![](http://blog.17study.com.cn/attachments/201904/tensorFlow2/nst-cnn1.jpg)
...
```
程序的输出结果如下图：  
![](http://blog.17study.com.cn/attachments/201904/tensorFlow2/nst-newart1.png)
...
```
再次执行，所得到的输出图片如下：  
![](http://blog.17study.com.cn/attachments/201904/tensorFlow2/nst-newart2.png)
