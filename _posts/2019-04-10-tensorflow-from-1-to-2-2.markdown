...
在TensorFlow 1.x中，是使用程序input_data.py来下载和管理MNIST的样本数据集。当前官方仓库的master分支中已经取消了这个代码，为了不去翻仓库，你可以在[这里](/attachments/201904/tensorFlow2/input_data.py)下载，放置到你的工作目录。  
...
样本集显示出来效果是这样的：  
![](/attachments/201904/tensorFlow2/mnist-train_Samples.png)
...
![](/attachments/201904/tensorFlow2/mnist_predict_samples.png)
