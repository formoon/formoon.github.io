...
card-image:		/attachments/201906/android_jni/android_java_c.jpeg
date:           2019-06-14
tags:           html
post-card-type: image
---
![](/attachments/201906/android_jni/android_java_c.jpeg)  
#### 前言
...
![](/attachments/201906/android_jni/sdk_setting.png)  
...
![](/attachments/201906/android_jni/ndk_setting.png)  
...
![](/attachments/201906/android_jni/javah_setting.png)  
其中三个需要设置的内容分别是：  
...
![](/attachments/201906/android_jni/new-project.png)  
选择基本的Empty Activity就好。  
![](/attachments/201906/android_jni/config-project.png)  
...
![](/attachments/201906/android_jni/layout_setting.png)  
...
执行的结果如图：  
![](/attachments/201906/android_jni/base_run1.png)  
点击两次按钮后，画面变为：  
![](/attachments/201906/android_jni/base_run2.png)  
...
一切选用默认设置，类名为JniLib。  
![](/attachments/201906/android_jni/new-java-class.png)  
...
![](/attachments/201906/android_jni/external-tools-javah.png)  
...
![](/attachments/201906/android_jni/second_run1.png)  
点击CALLJNI按钮后，文本框显示的信息表示JNI正常执行了。  

##### 解析包含JNI库的APK安装文件
先上一张apk包的文件结构图片吧：  
![](/attachments/201906/android_jni/apk-structure1.png)  
...
![](/attachments/201906/android_jni/compile-rs1.png)  
...
![](/attachments/201906/android_jni/apk-structure2.png)  
...
![](/attachments/201906/android_jni/layout1.png)  
...
![](/attachments/201906/android_jni/3_run1.png)  

还可以详细探究可执行文件，拷贝到Android设备之后的细节。这个使用adb工具连接到设备上就能看出来，请看下面执行的截图：  
![](/attachments/201906/android_jni/cmd1.png)  
...
![](/attachments/201906/android_jni/layout2.png)  
按键响应代码：  
```java
...
程序的执行结果如下：  
![](/attachments/201906/android_jni/4_run1.png)  
还可以在台式电脑中验证一下计算的结果：  
```bash
