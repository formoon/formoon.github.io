...
![](/attachments/201904/tensorFlow2/est-struct-1.png)
...
plt.show()
```
![](/attachments/201904/tensorFlow2/est-age-0.png)
...
plt.show()
```
![](/attachments/201904/tensorFlow2/est-sex-0.png)
男性乘客的数量，几乎是女性乘客的两倍。  
...
plt.show()
```
![](/attachments/201904/tensorFlow2/est-class-0.png)
图中显示，大多数乘客还是在三等舱。  
继续看乘客上船的地点：  
```python
...
plt.show()
```
![](/attachments/201904/tensorFlow2/est-town-0.png)
大多数乘客来自南安普顿。  
继续，把性别跟最后生存标注关联起来：  
```python
...
plt.show()
```
![](/attachments/201904/tensorFlow2/est-sex-1.png)
女性的存活率几乎超过男性的5倍。  
...
```
![](/attachments/201904/tensorFlow2/est-survive-ages-0.png)
...
plt.show()
```
![](/attachments/201904/tensorFlow2/est-predicted-probabilities-0.png)
...
plt.show()
```
![](/attachments/201904/tensorFlow2/est-predicted-ROC-1.png)
