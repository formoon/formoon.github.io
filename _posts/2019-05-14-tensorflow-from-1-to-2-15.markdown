...
![](/attachments/201904/tensorFlow2/js-vis-0.png)  
...
```
![](/attachments/201904/tensorFlow2/js-vis-1.png)  
#### 数据预处理
...
![](/attachments/201904/tensorFlow2/js-vis-2.png)  
...
```
程序执行，最终预测测试的输出结果如下：  
![](/attachments/201904/tensorFlow2/js-vis-3.png)  
